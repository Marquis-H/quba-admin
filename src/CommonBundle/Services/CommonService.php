            ...
            switch ($obj) {
                ...
                case $obj instanceof MatchApplication:
                    ...
                    if ($parent = $obj->getParent()) {
                        ...
                        foreach ($parent->getChildren()->getValues() as $value) {
                            array_push($children, [
                                ...
                                'contact' => $value->getContact() ? $value->getContact() : $value->getProfile()->getMobile(),
                        ...
                        $parentData = [
                            ...
                            'contact' => $parent->getContact() ? $parent->getContact() : $parent->getProfile()->getMobile(),
                    ...
                    $output = [
                        ...
                        'contact' => $obj->getContact() ? $obj->getContact() : $obj->getProfile()->getMobile(),
